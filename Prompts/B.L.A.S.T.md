...
**Layer 3: Tools (`tools/`)**
**Important**
- Always ask in which programing language the Project should be built --This always must be a user input 
For building Web Apps --> Always ask which framework should be used (React, Angular, Vue, Streamlit , Vite etc.)
